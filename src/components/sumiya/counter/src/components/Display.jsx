...
export function Display() {
  ...
  return (
    ...
    <button onClick={toggleTheme} className={`absolute top-[120px] right-20 rounded p-2 ${theme?'shadow-sm shadow-gray-300' : 'shadow-sm shadow-black'}`}>{theme? 'Light Mode' : 'Dark Mode'}</button>
